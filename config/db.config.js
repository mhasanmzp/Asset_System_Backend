...
db.AssetClient = require('../app/models/assetClient.model.js')(sequelize, Sequelize);
db.AssetWarehouse = require('../app/models/assetWarehouse.model.js')(sequelize, Sequelize);
